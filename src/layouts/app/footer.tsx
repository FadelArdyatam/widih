        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <TextLink href="#" className="text-gray-300 hover:text-yellow-500 transition-colors">
                  BERANDA
                </TextLink>
              </li>
              <li>
                <TextLink href="/artikel" className="text-gray-300 hover:text-yellow-500 transition-colors">
                  ARTIKEL
                </TextLink>
              </li>
              <li>
                <TextLink href="/dimensi-lantang" className="text-gray-300 hover:text-yellow-500 transition-colors">
                  7DIMENSI LANTANG
                </TextLink>
              </li>
              <li>
                <TextLink href="/informasi" className="text-gray-300 hover:text-yellow-500 transition-colors">
                  INFORMASI
                </TextLink>
              </li>
              <li>
                <TextLink href="/pencatatan" className="text-gray-300 hover:text-yellow-500 transition-colors">
                  PENCATATAN DAN PELAPORAN
                </TextLink>
              </li>
              <li>
                <TextLink href="/register" className="text-gray-300 hover:text-yellow-500 transition-colors">
                  REGISTRASI
                </TextLink>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <TextLink href="www.sidaya.kemendukbangga.go.id" className="text-gray-300 hover:text-yellow-500 transition-colors">
